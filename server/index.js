...
const IS_BTP = !!process.env.VCAP_SERVICES;
...
async function start() {
  ...
  app.listen(PORT, '0.0.0.0', () => {
    ...
    if (!IS_BTP) {
      console.log('UI5 resources proxied from CDN with disk cache');
    } else {
      console.log('Running on BTP (static files served by App Router)');
    }
  });
}
